...
class User(AbstractUser):
    ...
    language = models.CharField(
        choices=LANGUAGE_CHOICES, max_length=2, null=True, default=LANGUAGE_KOREAN
    )

    currency = models.CharField(
        choices=CURRENCY_CHICES, max_length=3, null=True, default=CURRENCY_KRW
    )
    ...
    login_method = models.CharField(
        max_length=50, choices=LOGIN_CHOICES, default=LOGIN_EAMIL
    )
    ...
    email_secret값이 이 숫자가 포함된 user를 찾아볼꺼야 그러면 verify (인증)이 되는 거야   """
